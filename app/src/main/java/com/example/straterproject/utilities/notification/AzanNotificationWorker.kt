package com.example.straterproject.utilities.notification
...
class AzanNotificationWorker(context: Context, workerParams: WorkerParameters) :
    ...
    private fun createNotificationBuilder(
        ...
        notificationBuilder.setSmallIcon(com.example.straterproject.R.drawable.checkbox_checked)
            ...
            .setPriority(NotificationCompat.PRIORITY_HIGH).addAction(
                com.example.straterproject.R.drawable.arrow_up, "تم", pendingIntent
            )
    ...
    override fun doWork(): Result {
        val azanSound =
            Uri.parse("android.resource://" + applicationContext.packageName + "/" + com.example.straterproject.R.raw.azan2)
