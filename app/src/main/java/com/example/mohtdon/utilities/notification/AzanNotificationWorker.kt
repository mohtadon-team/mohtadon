package com.example.mohtdon.utilities.notification
...
import com.example.mohtdon.ui.home.HomeFragment
...
class AzanNotificationWorker(context: Context, workerParams: WorkerParameters) :
    ...
    private fun createNotificationBuilder(
        ...
        notificationBuilder.setSmallIcon(com.example.mohtdon.R.drawable.checkbox_checked)
            ...
            .setPriority(NotificationCompat.PRIORITY_HIGH).addAction(
                com.example.mohtdon.R.drawable.arrow_up, "تم", pendingIntent
            )
    ...
    override fun doWork(): Result {
        val azanSound =
            Uri.parse("android.resource://" + applicationContext.packageName + "/" + com.example.mohtdon.R.raw.azan2)
